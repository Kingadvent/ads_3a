...
class LinkedList <E>  {   // a classe LinkedList com genéricos
	private Node head=null, tail=null;  // cabeça e cauda (início e final da lista)
        ...
        public E peekFirst() { //retorna o objeto no início da lista
            if(head == null) return null; else return (E)head.getValue();
        }
                
        public E peekLast() { //retorna o objeto no final da lista
            if(head == null) return null; else return (E)tail.getValue();
        }
	...
	public String toString (){ //retorna o conteúdo da lista dinâmica
        ...
        public E remove(int idx) { //eliminar e retornar o item na posição idx
            ...
            E value = (E)next.getValue(); //guardamos o valor a ser retornado
