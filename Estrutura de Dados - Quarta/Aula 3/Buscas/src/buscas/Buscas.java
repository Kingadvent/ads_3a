...
public class Buscas {
    ...
    public Buscas() {
        ...
        double b[] = {4.3, 6.1, 7.1, 8.9, 22.0, 9.4, 9.6, 10.5}; // vetor ordenado
        pos = buscaBinaria(b, 9.4);
        if (pos != -1) {
            System.out.println("O valor 9.4 foi encontrado na posição " + pos);
        } else {
            System.out.println("O valor 9.4 não foi encontrado no vetor.");
        }
