...
public class OrdenacaoQuickSort {
   ...
   private int separar(int vetor [], int inicio, int fim) {
      ...
      // O método medianaDeTres determina a mediana de três valores inteiros, 
      // troca os três valores e deixa o pivô (a mediana de três) na 
      // posição inicio, para não alterar a lógica original deste método.
   ...
   //só alteramos o tipo do vetor de double[] para int[]
   ...
   //só alteramos int temp; e o tipo do vetor de double[] para int[]
